...
refmeasure=8.8  ################################change value according to refrence 
points=[]
it=0
i=0
data=[]
...
Label(root, text="Click a picture", font=("times new roman", 25, "bold"),bg="black", fg="red"). pack()
...
#####printing points stored in "data"   
